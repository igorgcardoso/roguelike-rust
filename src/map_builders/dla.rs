...
impl DLABuilder {
    ...
    pub fn walk_inwards() -> Box<DLABuilder> {
        let mut dla = DLABuilder::new();
        dla.algorithm = DLAAlgorithm::WalkInwards;
        dla
    }
    ...
    pub fn walk_outwards() -> Box<DLABuilder> {
        let mut dla = DLABuilder::new();
        dla.algorithm = DLAAlgorithm::WalkOutwards;
        dla.brush_size = 2;
        dla
    }
    ...
    pub fn central_attractor() -> Box<DLABuilder> {
        let mut dla = DLABuilder::new();
        dla.algorithm = DLAAlgorithm::CentralAttractor;
        dla.brush_size = 2;
        dla
    }
    ...
    pub fn insectoid() -> Box<DLABuilder> {
        ...
        dla.algorithm = DLAAlgorithm::CentralAttractor;
        dla.brush_size = 2;
        dla.symmetry = Symmetry::Horizontal;
        dla
    }

    #[allow(dead_code)]
    pub fn heavy_erosion() -> Box<DLABuilder> {
        let mut dla = DLABuilder::walk_inwards();
        dla.floor_percent = 0.35;
        dla
    }
    ...
    fn build(&mut self, rng: &mut RandomNumberGenerator, build_data: &mut BuilderMap) {
        ...
        let mut floor_tile_count = count_floor_tile(&build_data.map);
        while floor_tile_count < desired_floor_tiles {
            ...
            build_data.take_snapshot();
            floor_tile_count = count_floor_tile(&build_data.map);
        }
    }
}
