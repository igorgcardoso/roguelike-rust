        ...
        match self.sort_by {
            ...
            RoomSort::Central => {
                ...
                let center_sort = |a: &Rect, b: &Rect| {
                    ...
                    let a_center_point = rltk::Point::new(a_center.0, a_center.1);
                    let b_center = b.center();
                    let b_center_point = rltk::Point::new(b_center.0, b_center.1);
                    let distance_a =
                        rltk::DistanceAlg::Pythagoras.distance2d(a_center_point, map_center);
                    let distance_b =
                        rltk::DistanceAlg::Pythagoras.distance2d(b_center_point, map_center);
